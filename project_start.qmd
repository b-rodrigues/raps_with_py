...
offers_country = (
    raw_data
    .filter(pl.col("locality").str.contains("Total.*offres"))
    .select(pl.col("year", "n_offers"))
)

country_level_data = country_level.join(offers_country, on = "year", how = "left").with_columns(
      pl.col("locality").str.replace_all(".*", "Grand-Duchy of Luxembourg")
)
